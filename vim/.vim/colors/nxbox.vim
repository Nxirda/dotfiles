" -----------------------------------------------------------------------------
" File: nbox.vim
" Description: Derived from gruv box 
...
if !exists('g:gruvbox_contrast_light')
  let g:gruvbox_contrast_light='hard'   "'medium'
endif
...
" fill it with absolute colors | will need to be changed
"let s:gb.dark0_hard  = ['#1d2021', 234]     " 29-32-33
let s:gb.dark0_hard  = ['#000000', 000]
...
if version >= 703
  ...
  call s:HL('CursorLineNr', s:purple, s:bg1)
endif
...
call s:HL('Search',    s:purple, s:bg0, s:inverse)
...
call s:HL('WildMenu', s:purple, s:bg1, s:bold)

" Directory names, special names in listing
hi! link Directory GruvboxPurpleBold
...
" Constants
hi! link String     GruvboxRed
hi! link Character  GruvboxRed
hi! link Boolean    GruvboxAqua
hi! link Number     GruvboxYellow
hi! link Float      GruvboxYellow
...
hi! link Define         GruvboxPurpleBold
hi! link Macro          GruvboxPurpleBold " | same as define no need to set
hi! link PreCondit      GruvboxPurpleBold
hi! link PreProc        GruvboxPurpleBold
...
" Special
hi! link SpecialChar        GruvboxOrange
hi! link Tag                Normal
hi! link Delimiter          GruvboxYellow
hi! link SpecialComment     GruvboxOrangeBold
hi! link Debug              GruvboxYellowBold
hi! link Special            GruvboxOrange

" Underlined
hi! link Underlined         GruvboxYellow
" }}}
...
if version >= 700
  ...
  call s:HL('PmenuSel', s:bg1, s:purple, s:bold)
