...
" for, do, while, etc.
hi! link Repeat GruvboxBlue "GruvboxRed
" case, default, etc.
hi! link Label GruvboxBlue "GruvboxRed
" try, catch, throw
hi! link Exception GruvboxRed
" sizeof, "+", "*", etc.
hi! link Operator GruvboxBlue "Normal
" Any other keyword
...
hi! link Include GruvboxPurple "GruvboxAqua
" Preprocessor #define
hi! link Define GruvboxPurple "GruvboxAqua
" Same as Define
hi! link Macro GruvboxPurple "GruvboxAqua
" Preprocessor #if, #else, #endif, etc.
hi! link PreCondit GruvboxRed "GruvboxAqua
...
hi! link Boolean GruvboxGreen 
" Number constant: 234, 0xff
hi! link Number GruvboxGreen
" Floating point constant: 2.3e10
hi! link Float GruvboxGreen

" Generic type
hi! link Type GruvboxPurple "GruvboxYellow
" static, register, volatile, etc
hi! link StorageClass GruvboxBlue "GruvboxOrange
" struct, union, enum, etc.
hi! link Structure GruvboxPurple "GruvboxAqua
" typedef
...
" hi! link cStructure GruvboxRed "GruvboxOrange
